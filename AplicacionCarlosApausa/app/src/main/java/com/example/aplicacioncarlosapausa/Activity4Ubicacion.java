...
public class Activity4Ubicacion extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity4_ubicacion);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.itemUbicacion:
                Toast.makeText(this,"Ya estas en LOCALIZACIÓN", Toast.LENGTH_SHORT).show();
                return true;
