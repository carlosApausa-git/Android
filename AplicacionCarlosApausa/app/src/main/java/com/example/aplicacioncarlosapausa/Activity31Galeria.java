...
public class Activity31Galeria extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity31_galeria);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.itemGaleria:
                Toast.makeText(this,"Ya estas en GALERIA", Toast.LENGTH_SHORT).show();
                return true;
